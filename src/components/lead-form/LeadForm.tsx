			...
			>
				<div>
					<input
						...
						placeholder="Имя"
						required
						className="w-full bg-brand-dark/50 border border-white/10 p-3 text-white placeholder-gray-500 focus:outline-none focus:border-brand-accent transition-colors font-sans"
					/>
				</div>
				<div>
					<input
				...
				<button
					type="submit"
					className="w-full text-center inline-flex justify-center items-center gap-4 border border-blue-500 text-blue-500 px-8 py-4 font-dot uppercase tracking-widest hover:bg-blue-500 hover:text-white transition-all"
				>
					Получить КП
				</button>
			</form>
