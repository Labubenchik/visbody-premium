...
export default function BlogOld() {
	return (
		<div className="relative pb-24 bg-transparent text-white min-h-screen font-sans">
			...
			<section className="py-24 text-center max-w-4xl mx-auto px-4 relative z-10">
				<div className="inline-block bg-blue-500/10 text-brand-accent px-5 py-2 rounded-full font-sans text-[10px] font-extrabold uppercase mb-8 tracking-[0.2em] border border-blue-400/20 shadow-sm backdrop-blur-md">
					Knowledge Base
				</div>
					...
					{ARTICLES.map((post, i) => (
						...
						>
							<div className="md:w-1/4">
								<div className="text-brand-accent font-dot text-xs uppercase tracking-widest mb-3">
									// {post.category}
								</div>
							...
							<div className="md:w-3/4">
								...
								<p className="text-gray-400 font-sans leading-relaxed mb-6">{post.desc}</p>
			...
			<section className="py-24 text-center">
				<button className="text-gray-600 font-dot uppercase tracking-widest text-xs border-b border-gray-600 hover:text-white hover:border-white transition-all pb-1">
					Показать все статьи
				</button>
			</section>
		</div>
