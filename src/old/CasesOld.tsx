...
export default function CasesOld() {
	...
	const filteredCases =
		activeCategory === "Все" ? CASES_DATA : CASES_DATA.filter((c) => c.category === activeCategory);

	return (
		<div className="relative pb-24 text-white min-h-screen overflow-hidden">
			{/* Background Glows */}
			...
			<section className="py-24 text-center px-4 relative z-10">
				<div className="inline-block border border-brand-accent/50 text-brand-accent px-4 py-1 uppercase font-dot text-xs mb-6 tracking-[0.3em]">
					Success Stories
				</div>
						...
						>
							...
							<div className="lg:w-2/3 p-8 md:p-12">
								<div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-8">
									<div>
										<div className="text-brand-accent font-dot text-xs uppercase tracking-widest mb-2">
											// {item.category}
										</div>
			...
			<section className="max-w-4xl mx-auto px-4">
				<div className="text-center mb-12">
					...
					<p className="text-gray-400 font-sans uppercase tracking-widest text-xs">
						Обсудим вашу бизнес-модель и рассчитаем потенциал.
					</p>
				</div>
