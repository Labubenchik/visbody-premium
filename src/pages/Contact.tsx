  ...
  return (
    <div className="relative pb-24 bg-transparent text-white min-h-screen font-sans">
      ...
      <section className="py-24 text-center max-w-4xl mx-auto px-4 relative z-10">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="inline-block bg-blue-500/10 text-brand-accent px-5 py-2 rounded-full font-sans text-[10px] font-extrabold uppercase mb-8 tracking-[0.2em] border border-blue-400/20 shadow-sm backdrop-blur-md">Get in Touch</motion.div>
        <h1 className="text-6xl md:text-9xl font-sans font-extrabold uppercase tracking-tighter mb-8 leading-[0.85] text-white">
          Свяжитесь <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-accent to-blue-400">с нами</span>
        </h1>
      ...
      <section className="max-w-6xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
         ...
         <div className="space-y-12">
            <div>
               <h3 className="text-2xl font-dot uppercase text-white mb-6 tracking-widest">// Прямые контакты</h3>
               <div className="space-y-6">
                  <div className="flex items-start gap-4">
                     ...
                     <div>
                        ...
                        <div className="text-2xl font-sans text-white">+7 (495) 000-00-00</div>
                     </div>
                  </div>
                  <div className="flex items-start gap-4">
                     <div className="bg-brand-accent/10 p-3 border border-brand-accent/20">
                     ...
                     <div>
                        ...
                        <div className="text-2xl font-sans text-white">info@visbody.ru</div>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div>
               <h3 className="text-2xl font-dot uppercase text-white mb-6 tracking-widest">// Шоу-рум в Москве</h3>
               <div className="flex items-start gap-4">
                  <div className="bg-brand-accent/10 p-3 border border-brand-accent/20">
                  ...
                  <div>
                     <p className="text-gray-400 font-sans leading-relaxed max-w-sm">
                        Москва, Бережковская набережная, дом 20, бизнес-центр «...», шоу-рум WellFitness.
                        <br/>
                        <span className="text-brand-accent mt-2 inline-block">Запись на демо — обязательна.</span>
                     </p>
                  </div>
               </div>
            </div>
            ...
            <div className="bg-brand-dark/50 border border-white/5 p-8 relative overflow-hidden">
               ...
               <p className="text-sm text-gray-500 font-sans leading-relaxed">
                  Мы — крупнейший поставщик профессионального фитнес-оборудования на территории РФ. 15 лет опыта, тысячи оснащенных клубов и собственная сервисная сеть.
               </p>
            </div>
         </div>
